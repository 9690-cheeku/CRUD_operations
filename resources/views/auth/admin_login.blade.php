...
<head>
  <meta charset="utf-8">
    ...
    <title>Flipmart Admin - Log in </title>
				...
				<div class="row justify-content-center no-gutters">
					<div class="col-lg-4 col-md-5 col-12">
						<div class="content-top-agile p-10">
							<h2 class="text-white">Login and Register task</h2>
							<p class="text-white-50">Register to start the session</p>							
						</div>
...
<br>
							...
							<div class="text-center">
								<button><a href="{{route('register')}}" class="text-info ml-5">Register</a></button>
							</div>
						</div>
					</div>
				</div>
