            ...
            @csrf
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="text" id="name" class="form-control pl-15 bg-transparent text-white plc-white" name="name" placeholder="Full Name">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" id="password_confirmation" class="form-control pl-15 bg-transparent text-white plc-white" name="password_confirmation" placeholder="Retype Password">
									</div>
								</div>
								  <div class="row">
									<div class="col-12">
